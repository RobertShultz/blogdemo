...
BLOG_AUTHOR = "Robert Shultz"  # (translatable)
BLOG_TITLE = "mimicblog"  # (translatable)
...
BLOG_EMAIL = "rshultz4@gmail.com"
BLOG_DESCRIPTION = "A blog for mimic data analysis"  # (translatable)
